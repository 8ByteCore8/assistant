...
- [5. Projects](#5-projects)
  ...
  - [5.4. `PUT` `/api/projects/` - Редактировать проект. [В процессе]](#54-put-apiprojects---редактировать-проект-в-процессе)
...
## 5.4. `PUT` `/api/projects/` - Редактировать проект. [В процессе]
